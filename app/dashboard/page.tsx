            ...
            <div className="col-md-6">
                <div className="card p-4">
                    ...
                    <form>
                        ...
                        <div className="mb-2">
                        {/* <Image src="#"  alt="Preview"  id="bannerPreview" width={100} height={100} style={{ width: "100px", height: "100px", display: "none" }} /> */}
                        </div>
                ...
                <table className="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                {/* <Image src="#" alt="Product" width={50} height={50} style={ { width: "50px",  height: "50px" } } /> */}
                            </td>
                            <td>$100</td>
                            <td>
